...
omega_siderite_std1 <- std1$omega_siderite
omega_siderite_std2 <- std2$omega_siderite

plot_simple_comparision(omega_siderite_std1, omega_siderite_std2, "std1", "std2", grid, "omega siderite", "depth (m)", "x")
```
