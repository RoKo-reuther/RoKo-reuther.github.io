...
Db          <- 1e-5  # mixing rate of the sediment; Bioturbation coefficient (m2/y); 1e-5 - 0.01 (Katsev 2006)
Db_mid      <- 0.025 # middle of Db decreasing zone (m)
Db_width    <- 0.05  # width of Db decreasing zone (m)
...
boundary_conditions <- c(
  ...
  MnO2_up    = 0.05,
  FeOH3_up   = function(t) {0.2 + ifelse(t >= 1/12 & t <= 2/12, 0.2 + 21.6, 0)},
  FeOH3_P_up = 0,
  FeCO3_up   = 0,
  S0_up      = 0,
  FeS_up     = 0,
...
equilibrium_std1 <- solve_tableau(component_total, tableau, logK, N_grid, tableau_species)

speciation_std1  <- equilibrium_std1$species_conc
