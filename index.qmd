...
- next meeting: 14.02.2024 | 09:30
- next steps:
  - add CaCO3 and Apatite
  - expand model grid to ~50cm
  - import porewater-data for comparision
  - introduce a second OM-pool
...
save_and_upload_results <- function(result, result_name, result_type) {
  ...
  # save results as .csv
  write.csv(result$y, paste0("last_results/", result_name, ".csv"), sep = ",")

  # upload to github
  system("git add last_results/")
  system("git commit -m 'update last_results'")
  system("git push")
